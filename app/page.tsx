...
export default function RootPage() {
  ...
  return (
    <main
      className="relative z-[100] flex min-h-screen w-full cursor-pointer flex-col items-center justify-center overflow-hidden bg-surface text-on-surface selection:bg-primary selection:text-on-primary"
